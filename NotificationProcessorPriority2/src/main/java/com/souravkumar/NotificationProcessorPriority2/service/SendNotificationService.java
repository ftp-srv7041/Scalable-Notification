package com.souravkumar.NotificationProcessorPriority2.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.souravkumar.NotificationProcessorPriority2.models.db.DeliveryLog;
import com.souravkumar.NotificationProcessorPriority2.models.db.Notification;
import com.souravkumar.NotificationProcessorPriority2.models.db.User;
import com.souravkumar.NotificationProcessorPriority2.models.enums.Channel;
import com.souravkumar.NotificationProcessorPriority2.models.enums.Status;
import com.souravkumar.NotificationProcessorPriority2.models.requests.EmailRequest;
import com.souravkumar.NotificationProcessorPriority2.models.requests.PushNRequest;
import com.souravkumar.NotificationProcessorPriority2.models.requests.SmsRequest;
import com.souravkumar.NotificationProcessorPriority2.repo.DeliveryLogRepository;
import com.souravkumar.NotificationProcessorPriority2.repo.NotificationRepository;
import com.souravkumar.NotificationProcessorPriority2.service.exceptions.DuplicateNotificationFoundException;
import com.souravkumar.NotificationProcessorPriority2.constants.Constants;
    ...
    public void sendSmsRequest(SmsRequest smsRequest, User user) {
        ...
        if(isSmsAllowed){
            try {
                ...
                kafkaTemplate.send(Constants.SMS_TOPIC, Constants.PRIORITY_KEY_FOR_PARTITIONS, notificationString);
    ...
    public void sendPushNRequest(PushNRequest pushNRequest, User user) {
        ...
        if(isPushNAllowed){
            try {
                ...
                kafkaTemplate.send(Constants.PUSH_N_TOPIC, Constants.PRIORITY_KEY_FOR_PARTITIONS, notificationString);
    ...
    public void sendEmailRequest(EmailRequest emailRequest, User user) {
        ...
        if(isEmailAllowed){
            try {
                ...
                kafkaTemplate.send(Constants.EMAIL_TOPIC, Constants.PRIORITY_KEY_FOR_PARTITIONS, notificationString);
