package com.souravkumar.PushNConsumer.consumer;

import com.souravkumar.PushNConsumer.service.MessageHandlerService;
import com.souravkumar.PushNConsumer.constants.Constants;
...
public class PriorityAwarePartitionConsumer {
    ...
    public void onAppStarted(ApplicationStartedEvent applicationStartedEvent){
         KafkaConsumer<String, String> consumer = (KafkaConsumer<String, String>) consumerFactory.createConsumer(Constants.GROUP_ID,"email-consumer");

        TopicPartition PARTITION_PRIORITY_1 = new TopicPartition(Constants.TOPIC,0);
        TopicPartition PARTITION_PRIORITY_2 = new TopicPartition(Constants.TOPIC,1);
        TopicPartition PARTITION_PRIORITY_3 = new TopicPartition(Constants.TOPIC,2);
